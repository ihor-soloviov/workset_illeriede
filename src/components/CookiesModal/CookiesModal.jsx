      ...
      <div className="cookiesModal-inner">
        <div className="cookiesModal-menu">
          ...
          <div className="cookiesModal-dropdown__items">
            ...
            >
              Diese Cookies sind unerlässlich, damit Sie die Website nutzen und
              ihre Funktionen nutzen können. Sie können nicht abgeschaltet
              werden. Sie werden als Antwort auf Anfragen von Dir gesetzt, wie
              z.B. das Einstellen Ihrer Datenschutzeinstellungen, das Einloggen
              oder das Ausfüllen von Formularen. Hier findest du eine Liste der
            ...
            >
              ...
              Marketinginteraktionen mit ihnen zu personalisieren. Basierend auf
              den von uns gewählten Einstellungen können Informationen von
              Marketing Cookies auch an andere Werbefirmen weitergegeben werden.
              Hier findest du eine Liste der von uns verwendeten Cookies.
            </div>
            <div className="cookiesModal-dropdown__item">
              <div className="dropdown-left">
            ...
            >
              Diese Cookies ermöglichen es dem Betreiber dieser Website, Inhalte
              von Videoplattformen und Social-Media-Plattformen anzuzeigen. Wenn
              Cookies von externen Medien akzeptiert werden, bedarf der Zugriff
              auf diese Inhalte keiner manuellen Zustimmung mehr, andernfalls
              werden diese standardmäßig blockiert. Die Informationen von Medien
              Cookies können an andere Werbefirmen weitergegeben werden. Hier
              findest du eine Liste der von uns verwendeten Cookies.
            </div>
          </div>
          <div className="cookiesModal-buttons">
            ...
            <button onClick={handleModal} className="default-btn left-btn">
              Auswahl speichern
            </button>
            <button
